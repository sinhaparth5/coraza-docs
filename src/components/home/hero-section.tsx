...
export function HeroSection() {
  return (
    <section className="relative isolate overflow-hidden border-b border-pastel-green-700/10 bg-pastel-green-50 dark:bg-pastel-green-950">
      <Image
        src={gradientImage}
        alt=""
        fill
        ...
        aria-hidden="true"
      />
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(115deg,rgba(242,253,240,0.8),rgba(224,251,221,0.2)_55%,rgba(195,245,189,0.4))] dark:bg-[linear-gradient(115deg,rgba(8,45,6,0.95),rgba(25,81,22,0.5))]" />
      ...
      <div className="relative mx-auto grid min-h-[46rem] w-full max-w-7xl grid-cols-1 px-5 py-16 sm:px-8 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:px-12 lg:py-20">
        <div className="relative z-10 max-w-2xl lg:col-start-1">
          <span className="mb-5 inline-flex rounded-full border border-pastel-green-700/20 bg-pastel-green-100/80 px-4 py-1.5 text-xs font-bold uppercase tracking-[0.14em] text-pastel-green-800 dark:border-pastel-green-300/20 dark:bg-pastel-green-900/60 dark:text-pastel-green-200">
            Open Source WAF
          </span>
          <h1 className="max-w-3xl text-balance text-4xl font-extrabold leading-[1.06] tracking-[-0.04em] text-pastel-green-950 sm:text-5xl lg:text-6xl dark:text-pastel-green-50">
            Coraza WAF and reverse proxy in a single Go binary
          </h1>
        </div>
        ...
        <div className="relative z-0 my-8 w-full lg:absolute lg:left-1/2 lg:top-36 lg:my-0 lg:w-[min(76rem,92vw)] lg:-translate-x-1/2">
          <Image
            ...
            className="h-auto w-full opacity-90 drop-shadow-[0_24px_55px_rgba(32,125,24,0.12)] dark:opacity-25"
            aria-hidden="true"
          />
        </div>
